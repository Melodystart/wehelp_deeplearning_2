...
def test(dataloader, model, loss_fn):
    ...
    with torch.no_grad():
      for X, y in dataloader:
          ...
          correct_top2 += torch.isin(y, top2_pred).sum().item()
    ...
    return  correct_rate, correct_rate_top2
...
correct_rate, correct_rate_top2 = test(test_loader, model, loss_fn)
